            ...
            data:{
                list:[
                    ...
                    },
                    {
                        name:"工业组装",
                        image:"zuzhuang.jpg",
                        text:"UV LED 技术可用于各种工业组装工艺过程，从小型的光学镜头到大型的汽车飞机制造业，其灵活性与可靠性均可获得令人满意的效果。锋翔公司产品具有使用寿命长，即时开关性及平稳UV输出性能等优势，可普遍应用于各种工艺过程。锋翔科技可根据客户的具体工艺过程帮助您设计特定的UV LED固化设备，为您提供最满意的高生产率，廉价生产过程的解决方案。"
                    },
                    {
                        name:"工业应用",
                        image:"gongye.jpg",
